import { FaCodepen, FaStore, FaUserFriends, FaUser, FaCode } from "react-icons/fa";
...
function User() {
  const { user, getUser, loading, clearUser } = useContext(GithubContext);
  ...
  if (loading) {
    return <img src={spinner} width={200} />;
  }
  const hireable = true;
  ...
  return (
    <>
      <div className="w-full mx-auto lg:w-10/12">
        ...
        <div className="w-full bg-base-100 shadow-md rounded-lg stats py-6 mb-5">
